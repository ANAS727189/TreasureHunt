...
You need to do the OPPOSITE of a normal quiz!
...
⬜ Leave: A (Don't do it) ✓
❌ Cross: B (Create README PR at Node.js)
❌ Cross: C (Create README PR at Express.js)
❌ Cross: D (Create README PR at React.js)

Summary:
Cross exactly 13 wrong answers and leave 19 correct answers uncrossed. Then click Submit to get "PASSED!
